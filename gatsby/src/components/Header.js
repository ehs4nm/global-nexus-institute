...
export const Header = () => {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-40 bg-white/70 dark:bg-black/70 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:supports-[backdrop-filter]:bg-black/50 border-b border-black/5 dark:border-white/10">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            <nav className="hidden md:flex items-center text-sm uppercase tracking-wide">
              ...
              <a href="/who-we-are.html" className="px-3 py-2 hover:text-accent-400">Who We Are</a>
              <a href="/what-we-do.html" className="px-3 py-2 hover:text-accent-400">What We Do</a>
            </nav>
