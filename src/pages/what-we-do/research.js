    ...
    <>
        ...
        <div className="brutalist-container">
          <div className="max-w-6xl">
            ...
            <div className="mb-16">
              ...
              <h1 className="brutalist-heading">{researchData.title}</h1>
              <div className="mt-6 brutalist-divider-bold" />
              <p className="mt-8 brutalist-subheading">{researchData.subtitle}</p>
              <p className="mt-6 brutalist-body max-w-3xl">{researchData.description}</p>
            </div>
          </div>
        </div>
      </section>
              ...
              {researchData.sections[0].areas.map((area, index) => (
                <article key={index} className="brutalist-card group p-8">
                  <div className="flex flex-col h-full">
                    ...
                    <h3 className="brutalist-card-title mb-4">{area.title}</h3>
                    
                    <p className="brutalist-body mb-6 flex-grow">{area.description}</p>
        ...
        <div className="brutalist-container">
          <div className="max-w-6xl">
            <div className="mb-16">
              ...
              <div className="mt-6 brutalist-divider-bold" />
              <p className="mt-8 brutalist-subheading">{researchData.sections[1].content}</p>
            </div>
                    ...
                    <div className="lg:w-2/3">
                      <div className="flex items-start justify-between mb-6">
                        ...
                        <div className="text-right">
                          ...
                          <div className="text-sm brutalist-body mt-1">{project.timeline}</div>
                        </div>
                      </div>
                      
                      <h3 className="brutalist-card-title mb-4">{project.title}</h3>
                      <p className="brutalist-body mb-6">{project.description}</p>
                    </div>
      ...
      <section className="brutalist-section">
        <div className="brutalist-container">
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-12">
              <h2 className="brutalist-heading text-4xl lg:text-5xl mb-6">Publications & Collaboration</h2>
            ...
            <div className="brutalist-card-inverted p-12 mb-12">
              ...
              <div className="grid sm:grid-cols-2 gap-8 mb-8">
                <div>
                  ...
                  <p className="brutalist-body text-sm mb-4">
