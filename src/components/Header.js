    ...
    <header className="fixed inset-x-0 top-0 z-40">
      ...
      <div className="bg-white dark:bg-black dark:text-white ">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          {/* Desktop header bar */}
          <div className="heading-1 hidden md:flex items-center justify-between h-20 w-full">
            ...
            <nav className="hidden md:flex items-center gap-1">
              ...
              {(menuItems || []).filter(it => it.showInDesktop).map((item) => {
                const className = 'px-4 py-2 text-sm font-mono uppercase tracking-widest hover:bg-black dark:hover:bg-white hover:text-white dark:hover:bg-white dark:hover:text-black transition-colors duration-200';
                if (item.type === 'hash') {
        ...
        <div className="heading-1 md:hidden flex items-center justify-between h-16 w-full min-w-0 px-4">
          <a href="/" className="flex items-center gap-2 focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white min-w-0 flex-1 overflow-hidden">
            ...
            <span className="font-display text-sm sm:text-base font-bold tracking-tight truncate">
              Global Nexus Institute
            </span>
          </a>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <button
              ...
              className="inline-flex items-center justify-center w-10 h-10 border-2 border-black dark:border-white hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white touch-manipulation"
            >
