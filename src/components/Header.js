    ...
    <header className="fixed inset-x-0 top-0 z-40">
      ...
      <div className="bg-white dark:bg-black backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:supports-[backdrop-filter]:bg-black/50 border-b border-black/5 dark:border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          {/* Desktop header bar */}
          <div className="heading-1 hidden md:flex items-center justify-between h-24 w-full">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              <button
                ...
                title="Toggle theme"
                onClick={toggleTheme}
                className="hidden md:inline-flex items-center justify-center w-10 h-10 rounded focus:outline-none focus:ring-2 focus:ring-accent-500 touch-manipulation"
              >
              ...
              <button
                ...
                className="md:hidden inline-flex items-center justify-center w-10 h-10 rounded border border-black/10 dark:border-white/15 hover:border-accent-500 focus:outline-none focus:ring-2 focus:ring-accent-500 touch-manipulation"
              >
        ...
        {/* Mobile header bar */}
        <div className="heading-1 md:hidden flex items-center justify-between h-16 w-full min-w-0 px-4">
          <a href="/" className="flex items-center gap-2 focus:outline-none focus:ring-2 focus:ring-accent-500 min-w-0 flex-1 overflow-hidden">
            <div className="h-8 w-8 rounded image-cover flex-shrink-0">
                <img src="/assets/favicon_io/android-chrome-512x512.png" alt="Global Nexus Institute" className="rounded" />
            </div>
            <span className="font-display text-sm sm:text-base tracking-wide truncate">Global Nexus Institute</span>
          </a>
          <div className="flex items-center gap-2 flex-shrink-0">
            <button
                aria-controls="menuPanel"
                aria-expanded={false}
                onClick={() => setMenuOpen(true)}
                className="inline-flex items-center justify-center w-10 h-10 rounded border border-black/10 dark:border-white/15 hover:border-accent-500 focus:outline-none focus:ring-2 focus:ring-accent-500 touch-manipulation"
              >
              <span className="sr-only">Open menu</span>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                <path fillRule="evenodd" d="M3 6.75A.75.75 0 013.75 6h16.5a.75.75 0 010 1.5H3.75A.75.75 0 013 6.75zm0 5.25a.75.75 0 01.75-.75h16.5a.75.75 0 010 1.5H3.75A.75.75 0 013 12zm.75 4.5a.75.75 0 000 1.5h16.5a.75.75 0 000-1.5H3.75z" clipRule="evenodd" />
