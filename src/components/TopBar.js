...
export const TopBar = () => {
  ...
  return (
    <div className="w-full bg-black text-white" style={{ height: 50 }}>
      <div className="mx-auto max-w-7xl h-full flex items-center justify-end gap-3">
        ...
        <button onClick={open} className="inline-flex items-center gap-2 rounded-md px-4 py-2 text-sm font-bold">
          NEWSLETTER
