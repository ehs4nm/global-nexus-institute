  ...
  return (
    <div className="w-full bg-black text-white" style={{ height: 50 }}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between gap-2 sm:gap-3">
        ...
        <button onClick={open} className="heading-1 inline-flex items-center gap-2 rounded-md px-3 sm:px-4 py-2 text-sm font-semibold whitespace-nowrap touch-manipulation">
