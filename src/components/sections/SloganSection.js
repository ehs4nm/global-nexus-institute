...
export const SloganSection = () => {
  return (
    <section id="slogan" className="min-h-[40vh] sm:h-[50vh] py-12 sm:py-16 relative flex items-center justify-center overflow-hidden border-black/5 dark:border-white/10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 py-8 sm:py-16 lg:py-20">
        <div className="lg:col-span-5">
          <p className="font-display text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight">HOW WE WORK</p>
        </div>
        <div className="lg:col-span-7 [&>:first-child]:mt-0">
          <h3 className="mt-4 lg:mt-6 text-xl sm:text-2xl md:text-3xl font-extrabold leading-tight text-gray-700 dark:text-white/80">Here to turn bold ideas into reality</h3>
