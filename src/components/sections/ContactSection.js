...
export const ContactSection = () => {
  return (
    <section id="contact" className="h-[60vh]  border-black/10 dark:border-white/[0.06] relative overflow-hidden flex items-center text-gray-800 dark:text-white">
      <div className="absolute -inset-y-24 -inset-x-10 opacity-20 blur-3xl bg-accent-500/20"></div>
      <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="title-hero font-display text-3xl sm:text-5xl font-extrabold leading-tight">Join the Nexus.</h2>
